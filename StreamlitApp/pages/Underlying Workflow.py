...
- Data cleaning: read in data and prepare it for data analysis; steps include: tidying up the categorical features, feature engineering, outlier analysis, categorizing missing value type and performing imputation, etc.
